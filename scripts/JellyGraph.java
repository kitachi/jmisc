...
public class JellyGraph {
    ...
    public JobStatus newIngestStatus(String jobName, String ts, String topUUID, Integer status, String statusDesc, Timestamp start, Timestamp end) {
        JobStatus s = new JobStatus();
        updateIngestStatus(s, jobName, ts, topUUID, status, statusDesc, start, end);
        return s;
    }
        
    public JobStatus updateIngestStatus(JobStatus s, String jobName, String ts, String topUUID, Integer status, String statusDesc, Timestamp start, Timestamp end) {    
        s.jobName = jobName;
        s.jobTS = ts;
        s.topUUID = topUUID;
        s.status = status;
