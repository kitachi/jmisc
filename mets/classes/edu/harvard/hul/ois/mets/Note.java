...
/**
 * This class encapsulates the &lt;<tt>note</tt>&gt; element.
    ...
    extends MetsVElement
{
    ...
    /**
     * Instantiate a <tt>Note</tt> object.
     */
    public Note ()
    {
	super ("note");
    ...
    /**
     * Instantiate a <tt>Note</tt> object de-serialized from the input
     * stream.
     * @param r Reader
     * @return Note object
     * @throws MetsException De-serializing exception
     */
    public static Note reader (MetsReader r)
	...
	if (_content == null || _content.isEmpty ()) {
	    throw new MetsException ("No note content");
	}
